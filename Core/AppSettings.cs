...
namespace Core
{
    public static class AppSettings
    {
        ...
        public static string APP_WEBSITE = "https://cs-demo-manager.com";
        public static Version APP_VERSION = new Version("2.15.0");
        ...
        public static Regex STEAM_COMMUNITY_URL_REGEX =
            new Regex("(?:https?:\\/\\/)?steamcommunity\\.com\\/(?:profiles|id)\\/(?<steamID>[a-zA-Z0-9]+)");
        ...
        public static string GetCsgoExePath()
        {
            ...
            if (string.IsNullOrEmpty(csgoFolderPath))
            {
                return null;
            }

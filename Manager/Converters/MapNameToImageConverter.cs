        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            switch (demo.MapName)
            {
                ...
                case "de_inferno":
                    ...
                    {
                        return new Uri(AppSettings.RESOURCES_URI + "images/maps/preview/new_inferno.png", UriKind.RelativeOrAbsolute);
                    }
                ...
                case "de_nuke":
                    ...
                    {
                        return new Uri(AppSettings.RESOURCES_URI + "images/maps/preview/new_nuke.png", UriKind.RelativeOrAbsolute);
                    }

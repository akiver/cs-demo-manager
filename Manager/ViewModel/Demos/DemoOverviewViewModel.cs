    ...
    public class DemoOverviewViewModel : BaseViewModel
    {
        ...
        public Player SelectedPlayer
        {
            ...
            set
            {
                ...
                if (CurrentTeamSelector != null)
                {
                    CurrentTeamSelector = null;
                }
            }
        }
            ...
            get
            {
                return _playCommand
                       ?? (_playCommand = new RelayCommand(
                           async () =>
                           {
                               ...
                               try
                               {
                                   ...
                                   foreach (List<PositionPoint> positionPoints in Points)
                                   {
                                       ...
                                       if (!PlayersColor.Contains(playerColor))
                                       {
                                           PlayersColor.Add(playerColor);
                                       }
                                   }

                                   if (!Points.Any())
                                   {
                                       await _dialogService.ShowMessageAsync(Properties.Resources.DialogNoPointsFound,
                           ...
                           () => (!IsBusy && !IsPaused || IsBusy && IsPaused) && (SelectedPlayer != null || CurrentTeamSelector != null) &&
                                 SelectedRound != null));
            }
        }

    ...
    public class DemoHeatmapViewModel : BaseViewModel
    {
                           ...
                           async () =>
                           {
                               ...
                               catch (Exception e)
                               {
                                   ...
                                   await _dialogService
                                       .ShowErrorAsync(Properties.Resources.DialogErrorExportingHeatmap, MessageDialogStyle.Affirmative)
        ...
        public DemoHeatmapViewModel(IDialogService dialogService, ICacheService cacheService, IMapService mapService)
        {
            ...
            if (IsInDesignMode)
            {
                ...
                DispatcherHelper.CheckBeginInvokeOnUI(async () => { await LoadData(); });
            }
        }

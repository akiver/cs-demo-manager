    ...
    public class DemoMovieViewModel : DemoViewModel
    {
        ...
        public bool FocusOnPlayer
        {
            ...
            set
            {
                ...
                else if (FocusedPlayer == null && Demo.Players.Count > 0)
                {
                    FocusedPlayer = Demo.Players[0];
                }
                       ...
                       ?? (_saveCommentDemo = new RelayCommand(
                           async () =>
                           {
                               ...
                               catch (Exception e)
                               {
                                   ...
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogErrorSavingCommentDemo,
                ...
                return _generateMovie
                       ?? (_generateMovie = new RelayCommand(
                           async () =>
                           {
                               ...
                               {
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogInstallVirtuaDubFirst,
                                       MessageDialogStyle.Affirmative);
                                   return;
                               }
                               ...
                               {
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogSelectCsgoExeLocation,
                                       MessageDialogStyle.Affirmative);
                                   return;
                               }
                               ...
                               {
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogSelectRawFilesDestination,
                                       MessageDialogStyle.Affirmative);
                                   return;
                               }
                               ...
                               if (StartTick <= 0)
                               {
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogSelectValidStartTIck,
                                       MessageDialogStyle.Affirmative);
                                   return;
                               }
                               ...
                               {
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogEndTickGreaterThanStartTick,
                                       MessageDialogStyle.Affirmative);
                                   return;
                               }
                               ...
                               if (RequiredSpace >= 30)
                               {
                                   MessageDialogResult confirm = await _dialogService.ShowMessageAsync(
                                       string.Format(Properties.Resources.DialogAmountSpaceRequired, RequiredSpace),
                               ...
                               try
                               {
                                   ...
                                   if (_movieService.IsFirstTgaExists())
                                   {
                                       ...
                                       {
                                           if (choice == MessageDialogResult.FirstAuxiliary)
                                           {
                                               return;
                                           }
                                           ...
                                           {
                                               _movieConfig.GenerateRawFiles = false;
                                           }
                                       }
                                       else
                                       {
                                   ...
                                   {
                                       if (!player.DisplayKills)
                                       {
                                           _movieConfig.BlockedSteamIdList.Add(player.SteamId);
                                       }

                                       if (player.HighlightKills)
                                       {
                                           _movieConfig.HighlightSteamIdList.Add(player.SteamId);
                                       }
                                   }
            ...
            get
            {
                return _copyPlayerSteamId
                       ?? (_copyPlayerSteamId = new RelayCommand<PlayersSelection>(
                           player => { System.Windows.Clipboard.SetText(player.SteamId.ToString()); },
                       ...
                       ?? (_installFFmpeg = new RelayCommand(
                           async () =>
                           {
                               try
                               {
                                   ...
                                   if (!isHlaeInstalled)
                                   {
                                       await _dialogService.ShowErrorAsync(Properties.Resources.DialogInstallHLAEFirst,
                                           MessageDialogStyle.Affirmative);
                                       return;
                                   }
                                   ...
                                   if (!installed)
                                   {
                                       await _dialogService.ShowMessageAsync(Properties.Resources.DialogFFmpegHasNotInstalled,
                                           MessageDialogStyle.Affirmative);
                                       return;
                                   }
                               ...
                               {
                                   Logger.Instance.Log(e);
                                   await _dialogService.ShowErrorAsync(string.Format(Properties.Resources.DialogErrorInstallingFFmpeg, e.Message),
                                       MessageDialogStyle.Affirmative);
                               }
                               finally
                               {
                       ...
                       ?? (_installVirtualDub = new RelayCommand(
                           async () =>
                           {
                               try
                               {
                                   ...
                                   if (!installed)
                                   {
                                       await _dialogService.ShowMessageAsync(Properties.Resources.DialogVirtualDubHasNotBeenInstalled,
                                           MessageDialogStyle.Affirmative);
                                       return;
                                   }

                                   await _dialogService.ShowMessageAsync(Properties.Resources.DialogVirtualDubHasBeenInstalled,
                                       MessageDialogStyle.Affirmative);
                               ...
                               {
                                   Logger.Instance.Log(e);
                                   await _dialogService.ShowErrorAsync(string.Format(Properties.Resources.DialogErrorInstallingVirtualDub, e.Message),
                                       MessageDialogStyle.Affirmative);
                               }
                               finally
                               {
                       ...
                       ?? (_installHLAE = new RelayCommand(
                           async () =>
                           {
                               try
                               {
                                   ...
                                   if (string.IsNullOrEmpty(CsgoExePath))
                                   {
                                       MessageDialogResult confirm = await _dialogService.ShowMessageAsync(Properties.Resources.DialogSelectCsgoPath,
                                           MessageDialogStyle.AffirmativeAndNegative);
                                       if (confirm == MessageDialogResult.Negative)
                                       {
                                           return;
                               ...
                               {
                                   Logger.Instance.Log(e);
                                   await _dialogService.ShowErrorAsync(string.Format(Properties.Resources.DialogErrorInstallingHLAE, e.Message),
                                       MessageDialogStyle.Affirmative);
                               }
                               finally
                               {
                       ...
                       ?? (_updateHLAE = new RelayCommand(
                           async () =>
                           {
                               try
                               {
                                   ...
                                   {
                                       await _dialogService.ShowMessageAsync(Properties.Resources.DialogNoHLAEUpdateAvailable,
                                           MessageDialogStyle.Affirmative);
                                       return;
                                   }
                ...
                return _selectRawFilesFolderDestination
                       ?? (_selectRawFilesFolderDestination = new RelayCommand(
                           () =>
                           {
                               ...
                               {
                                   RawFilesFolderDestination = folderPath;
                               }
                           }, () => !IsBusy));
            }
        }
            ...
            get
            {
                return _navigateToRawFilesFolder
                       ?? (_navigateToRawFilesFolder = new RelayCommand(
                           async () => { await NavigateToFolder(RawFilesFolderDestination); },
            ...
            get
            {
                return _navigateToOutputFileFolderDestination
                       ?? (_navigateToOutputFileFolderDestination = new RelayCommand(
                           async () => { await NavigateToFolder(OuputFileDestinationFolder); },
            ...
            get
            {
                return _navigateToFFmpegFolder
                       ?? (_navigateToFFmpegFolder = new RelayCommand(
                           async () => { await NavigateToFolder(FFmpegService.GetFFmpegPath()); },
            ...
            get
            {
                return _navigateToHLAEFolder
                       ?? (_navigateToHLAEFolder = new RelayCommand(
                           async () => { await NavigateToFolder(HlaeService.GetHlaePath()); },
            ...
            get
            {
                return _navigateToVirtualDubFolder
                       ?? (_navigateToVirtualDubFolder = new RelayCommand(
                           async () => { await NavigateToFolder(VirtualDubService.GetVirtualDubPath()); },
            ...
            get
            {
                return _updateStartTick
                       ?? (_updateStartTick = new RelayCommand<int>(
                           tick => { StartTick = tick; }, tick => !IsBusy));
            }
        }
                           ...
                           async () =>
                           {
                               try
                               {
                                   ...
                                   if (AppSettings.IsInternetConnectionAvailable())
                                   {
                                       ...
                                       if (isUpdateAvailable)
                                       {
                                           await _dialogService.ShowMessageAsync(Properties.Resources.DialogPleaseUpdateHLAE,
                                               MessageDialogStyle.Affirmative);
                                       }
                                   }
                               }

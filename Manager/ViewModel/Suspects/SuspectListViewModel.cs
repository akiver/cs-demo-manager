...
namespace Manager.ViewModel.Suspects
{
    public class SuspectListViewModel : BaseViewModel, IDisposable
    {
                ...
                return _addSuspectCommand
                       ?? (_addSuspectCommand = new RelayCommand(
                           async () =>
                           {
                               ...
                               try
                               {
                                   string steamInput = await _dialogService.ShowInputAsync(Properties.Resources.DialogAddSuspect,
                                   ...
                                   {
                                       await _dialogService.ShowErrorAsync(Properties.Resources.DialogErrorInvalidSteamId,
                                           MessageDialogStyle.Affirmative);
                                   }
                               }
                               catch (Exception e)
                               {
                                   ...
                                   await _dialogService.ShowErrorAsync(Properties.Resources.DialogErrorWhileRetrievingSuspectInformation,
                                       MessageDialogStyle.Affirmative);
                               }
                               finally
                               {
                       ...
                       ?? (_removeSelectedSuspectsCommand = new RelayCommand(
                           async () =>
                           {
                               foreach (Suspect suspect in SelectedSuspects.ToList())
                               {
                                   ...
                                   if (!removed)
                                   {
                                       await _dialogService.ShowErrorAsync(Properties.Resources.DialogErrorWhileDeletingSuspect,
                                           MessageDialogStyle.Affirmative);
                                   }
                                   else
                                   {
                ...
                return _displayDemosCommand
                       ?? (_displayDemosCommand = new RelayCommand(
                           async () =>
                           {
                               ...
                               if (!demos.Any())
                               {
                                   await _dialogService.ShowMessageAsync(Properties.Resources.DialogNoDemosSuspectFound,
                                       MessageDialogStyle.Affirmative);
                                   return;
                               }
                       ...
                       ?? (_moveToWhitelistCommand = new RelayCommand(
                           async () =>
                           {
                               ...
                               foreach (Suspect suspect in SelectedSuspects.ToList())
                               {
                                   ...
                                   if (!hasMoved)
                                   {
                                       await _dialogService.ShowErrorAsync(Properties.Resources.DialogErrorWhileMovingSuspects,
                                           MessageDialogStyle.Affirmative);
                                   }
                                   else
                                   {
        ...
        private async Task LoadSuspects()
        {
            ...
            {
                Logger.Instance.Log(e);
                await _dialogService.ShowErrorAsync(Properties.Resources.DialogErrorWhileRetrievingSuspectsInformation,
                    MessageDialogStyle.Affirmative);
            }
        }

...
namespace Services.Concrete.Movie
{
    public class MovieService
    {
        ...
        /// <summary>
        /// Returns the path of the .wav file generated by HLAE.
        /// Before the version 2.133.0 the file name was "audio_xxxxxxxx.wav", now it's simply "audio.wav".
        /// </summary>
        /// <returns></returns>
        private string GetLastWavFilePath()
        {
            ...
            var audioFilePath = Path.Combine(lastTakeFolderPath, "audio.wav");

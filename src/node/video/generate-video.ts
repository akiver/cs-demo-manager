...
import { moveStartMovieFiles } from 'csdm/node/video/generation/move-startmovie-files';
...
import { moveHlaeRawFilesToOutputFolder } from './generation/move-hlae-files';

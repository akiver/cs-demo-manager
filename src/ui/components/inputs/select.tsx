...
export function Select<ValueType extends string | number = string>({
  ...
  return (
    <select
      id={id}
      className="h-[30px] bg-gray-50 border border-gray-400 rounded disabled:bg-gray-400 enabled:hover:border-gray-900 focus:border-gray-900 outline-none pl-12 appearance-none"
      disabled={isDisabled}
      value={value}
      onChange={(event) => {

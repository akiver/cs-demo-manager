...
const variantsClasses: { [variantName in ButtonVariant]: string } = {
  [ButtonVariant.Default]:
    'bg-gray-50 border-gray-400 text-gray-800 active:bg-gray-200 hover:text-gray-900 hover:border-gray-900 focus:border-gray-800 focus-visible:outline-none',

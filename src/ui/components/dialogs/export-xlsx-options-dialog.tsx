...
type Props = {
  ids: string[];
  renderCheckboxes: (isSingleSelection: boolean, outputType: XlsxOutputType) => ReactNode;
        ...
        <DialogContent>
          <div className="gap-y-8">
            ...
            <div className="max-w-[448px] mt-8">
              ...
              <div className="flex gap-8 flex-wrap">{renderCheckboxes(isSingleSelection, outputType)}</div>
            </div>
          </div>
        </DialogContent>
        <DialogFooter>

...
export function ValveLogo({ className }: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 436 121.06" className={className}>
      <polygon points="142.57 36.95 134.84 67.88 151.01 67.88 142.57 36.95" fill="#f74843"></polygon>
      <path

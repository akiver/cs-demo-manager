      ...
      <div className="flex flex-col gap-y-8">
        ...
        <div className="flex flex-col gap-y-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-[60px_100px_100px_100px_1fr] p-4 bg-gray-200 rounded-t gap-4">
            ...
            <ul>
              {video.sequences.map((sequence) => {
                return (
                  <li
                    key={sequence.number}
                    className="grid grid-cols-[60px_100px_100px_100px_1fr] gap-4 border p-4 last:rounded-b"
                  >
                    <p>{sequence.number}</p>

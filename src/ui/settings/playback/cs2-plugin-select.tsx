...
export function Cs2PluginSelect() {
  ...
  const update14168 = formatDate('2026-07-09', dateOptions);
    ...
    switch (version) {
      ...
      case PluginVersion[14112]:
        return (
          <div>
            <p>
              <Trans>
                You selected a version compatible with CS2 from the {update14104} update up to the {update14112} update.
              </Trans>
            </p>
            <p>
              <Trans>
                If not using a custom build, you must select the CS2 beta branch <strong>"1.41.1.2"</strong> in your
                Steam library to use this version.
              </Trans>
            </p>
          </div>
      ...
      case PluginVersion[14152]:
        return (
          <p>
            <Trans>
              You selected a version compatible with CS2 from the {animgraph2UpdateDate} update up to the {update14168}{' '}
              update.
            </Trans>
          </p>
        );
      case PluginVersion[14168]:
        return (
          <p>
            <Trans>
